...
//         i2 = v(0.0001) // used when serializing sections prior to sim start
    ...
    plot_multiple_responses([responses], cp_filename, fig=model_fig)
...
def plot_multiple_responses(responses, cp_filename, fig):
    import pandas as pd
    '''creates subplots'''
    traces = ( 'step_-0.4.soma.v', 
              'step_-0.2.soma.v', 'step_0.2.soma.v', 'step_0.4.soma.v',
              'step_0.6.soma.v', 'step_0.8.soma.v')
